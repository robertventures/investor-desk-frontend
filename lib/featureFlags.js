 ...
 * Manual Bank Entry
 * 
 * When true: Shows "Enter Bank Details Manually" option alongside Plaid
 * When false: Only Plaid connection is available (opens directly, no modal)
 */
export const MANUAL_BANK_ENTRY_ENABLED = false
